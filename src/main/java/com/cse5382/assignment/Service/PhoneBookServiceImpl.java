...
public class PhoneBookServiceImpl implements PhoneBookService {
	...
	public boolean getByNumber( String phoneNumber) {
		if(phoneBookRepository.findByPhoneNumber(phoneNumber).isPresent()) {
			return true;
		}else {
			return false;
		}
	...
	public boolean getByName( String name) {
		if(phoneBookRepository.findByName(name).isPresent()) {
			return true;
		}else {
			return false;
		}
